...
public class DBUtils {
    ...
    public CompletableFuture<HashMap<String, String>> refreshEntries(Giveaway giveaway) {
    ...
    public CompletableFuture<Void> saveEntries(Giveaway giveaway) {
        return CompletableFuture.runAsync(() -> {
            ...
            try (Connection conn = getConnection()) {
                ...
                for (Map.Entry<String, String> entry : entries.entrySet()) {
                    ...
                    Thread.sleep(100); // Add a wait time of 100ms between saving entries
                }
